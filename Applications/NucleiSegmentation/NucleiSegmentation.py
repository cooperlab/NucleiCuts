...
def main(args):
    ...
    _, imNucleiSegMask = nucleicuts.nuclear_cut(
        imNucleiStain,
        Sigma=args.binary_cut_sigma,
        SigmaMin=args.min_radius * np.sqrt(2),
        SigmaMax=args.max_radius * np.sqrt(2),
        r=args.local_max_search_radius,
        MinArea=args.min_nucleus_area,
        MinWidth=args.min_nucleus_diameter,
        Background=args.multiwaycut_background_cost,
        Smoothness=args.multiwaycut_smoothness
    )
    ...
    annotation = {
        ...
        "attributes": {
            "algorithm": {
                ...
                "nuclei_segmentation": "nuclear_cut"
            }
        },
        "elements": []
    }
